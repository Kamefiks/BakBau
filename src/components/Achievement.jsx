...
function Achievement({ text, type, data }) {
  return (
    <div
      ...
      } flex justify-center items-center w-[286px] 2xl:w-[35%] sm:w-[70%]  h-[76px] sm:h-[207px]`}
    >
      <div
        ...
        } rounded-[19px] pl-5 sm:pr-5 sm:pl-5 sm:pb-8 justify-between flex-col flex  w-[281px] sm:w-[100%]  h-[72px] sm:h-[202px]`}
      >
